...
static void test_gs_seq_cpu(WorkloadType workload_type) {
  ...
  // SmpEngineGsSeq
  auto smp_engine_gs_seq = bamboosmp::SmpEngineGs(*smp, WORKLOAD_SIZE);
...
int main(int argc, char *argv[]) {
  ...
  test_gs_seq_cpu(CONGESTED);
  // test_gs_par_cpu(RANDOM);
