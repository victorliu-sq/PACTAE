...
namespace bamboosmp {
  SmpEngineMw3T1::SmpEngineMw3T1(const SmpObj &smp, size_t n)
    : smp_(smp),
      n_(n),
  ...
  void SmpEngineMw3T1::CoreProc() {
    ...
    Mw3T1CoreKernel<<<grid_size, block_size, 0, cuda_stream_.cuda_stream()>>>(
      n,
      pref_list_m_dview,
      pref_list_w_dview,
      rank_mtx_w_dview,
  ...
  auto SmpEngineMw3T1::PostProc() -> Matching {
