...
namespace bamboosmp {
  SmpEngineMw3F8Bottom::SmpEngineMw3F8Bottom(const SmpObj &smp, size_t n)
    : smp_(smp),
      n_(n),
  ...
  void SmpEngineMw3F8Bottom::InitProc() {
  ...
  void SmpEngineMw3F8Bottom::CoreProc() {
    // const int n = this->n_;
    ...
    //   int mi, mi_rank, w_idx, w_rank, mj_rank, mj_rank2;
    //   mi = tid;
    //   w_rank = 0;
    ...
    // Raw device pointers from your device buffers
  ...
  auto SmpEngineMw3F8Bottom::PostProc() -> Matching {
