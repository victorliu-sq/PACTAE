...
namespace bamboosmp {
  SmpEngineMw2::SmpEngineMw2(const SmpObj &smp, size_t n)
    : smp_(smp),
      n_(n),
  ...
  SmpEngineMw2::~SmpEngineMw2() {
    delete[] atomic_partner_rank_;
  }

  void SmpEngineMw2::InitProc() {
  ...
  auto SmpEngineMw2::PostProc() -> Matching {
