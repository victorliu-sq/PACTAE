#ifndef SMP_ENGINE_LA_3_F8_H
#define SMP_ENGINE_LA_3_F8_H
...
namespace bamboosmp {
  class SmpEngineLa3F8Bottom : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineLa3F8Bottom(const SmpObj &smp, size_t n);

    ~SmpEngineLa3F8Bottom() = default;

    auto GetEngineName() const -> String override {
      return "LA-Par-GPU-MIN:Figure8";
    }
    ...
    void PrintProfilingInfo() override {
      std::cout << "Executing SmpEngineLaMIN For Profiling ... " << std::endl;
    }
