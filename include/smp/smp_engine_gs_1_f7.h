#ifndef SMP_ENGINE_GS_1_F7_H
#define SMP_ENGINE_GS_1_F7_H
...
namespace bamboosmp {
  class SmpEngineGsF7 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineGsF7(const SmpObj &smp, const size_t n);

    ~SmpEngineGsF7() {
    }

    auto GetEngineName() const -> String override {
      return "Gs-Seq-CPU:Figure7";
    }
