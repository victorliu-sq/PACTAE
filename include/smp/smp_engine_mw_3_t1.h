#ifndef SMP_ENGINE_MW_3_T1_H
#define SMP_ENGINE_MW_3_T1_H
...
namespace bamboosmp {
  class SmpEngineMw3T1 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw3T1(const SmpObj &smp, size_t n);

    ~SmpEngineMw3T1() = default;
