#ifndef SMP_ENGINE_LA_3_F8_TRIGHT_H
#define SMP_ENGINE_LA_3_F8_TRIGHT_H
...
namespace bamboosmp {
  class SmpEngineLa3F8TRight: public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineLa3F8TRight(const SmpObj &smp, size_t n);

    ~SmpEngineLa3F8TRight() = default;

    auto GetEngineName() const -> String override {
      return "LA-Par-GPU-MIN:Figure8-TRight";
    }
...
#endif //SMP_ENGINE_LA_3_F8_TRIGHT_H
