#ifndef SMP_ENGINE_MW_4_F8_TRIGHT_H
#define SMP_ENGINE_MW_4_F8_TRIGHT_H
...
namespace bamboosmp {
  class SmpEngineMw4F8TRight : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw4F8TRight(const SmpObj &smp, size_t n);

    ~SmpEngineMw4F8TRight() = default;

    auto GetEngineName() const -> String override {
      return "MW-Par-GPU-MIN:Figure8-TRight";
    }
...
#endif //SMP_ENGINE_MW_4_F8_TRIGHT_H
