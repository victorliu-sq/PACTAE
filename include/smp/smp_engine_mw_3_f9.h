#ifndef SMP_ENGINE_MW_3_F9_H
#define SMP_ENGINE_MW_3_F9_H
...
namespace bamboosmp {
  class SmpEngineMw3F9 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw3F9(const SmpObj &smp, size_t n);

    ~SmpEngineMw3F9() = default;

    auto GetEngineName() const -> String override {
      return "MW-Par-GPU-CAS:Figure9Config";
    }
