#ifndef SMP_ENGINE_MW_4_F8_H
#define SMP_ENGINE_MW_4_F8_H
...
namespace bamboosmp {
  class SmpEngineMw4F8Bottom : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw4F8Bottom(const SmpObj &smp, size_t n);

    ~SmpEngineMw4F8Bottom() = default;

    auto GetEngineName() const -> String override {
      return "MW-Par-GPU-MIN:Figure8";
    }
    ...
    void PrintProfilingInfo() override {
      std::cout << "Executing SmpEngineMwMIN ... " << std::endl;
    }
