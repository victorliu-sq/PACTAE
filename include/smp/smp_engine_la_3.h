#ifndef SMP_ENGINE_LA_3_H
#define SMP_ENGINE_LA_3_H
...
namespace bamboosmp {
  class SmpEngineLa3 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineLa3(const SmpObj &smp, size_t n);

    ~SmpEngineLa3() = default;

    auto GetEngineName() const -> String override {
      return "LA-Par-GPU-MIN";
    }
