#ifndef SMP_ENGINE_LA_2_F7_H
#define SMP_ENGINE_LA_2_F7_H
...
namespace bamboosmp {
  class SmpEngineLa2F7 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineLa2F7(const SmpObj &smp, size_t n);

    ~SmpEngineLa2F7() = default;

    auto GetEngineName() const -> String override {
      return "LA-Par-GPU-CAS:Figure7";
    }
