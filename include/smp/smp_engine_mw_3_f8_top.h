#ifndef SMP_ENGINE_MW_3_H
#define SMP_ENGINE_MW_3_H
...
namespace bamboosmp {
  class SmpEngineMw3F8Top : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw3F8Top(const SmpObj &smp, size_t n);

    ~SmpEngineMw3F8Top() = default;

    auto GetEngineName() const -> String override {
      return "MW-Par-GPU-CAS";
    }
