#ifndef SMP_ENGINE_MW_4_H
#define SMP_ENGINE_MW_4_H
...
namespace bamboosmp {
  class SmpEngineMw4 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineMw4(const SmpObj &smp, size_t n);

    ~SmpEngineMw4() = default;

    auto GetEngineName() const -> String override {
      return "MW-Par-GPU-MIN";
    }
