#ifndef SMP_ENGINE_GS_PAR_H
#define SMP_ENGINE_GS_PAR_H
#include "smp.h"
#include "smp_engine_abs.h"

namespace bamboosmp {
  class SmpEngineGs2 : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineGs2(const SmpObj &smp, size_t n);

    ~SmpEngineGs2();

    auto GetEngineName() const -> String override {
      return "Gs-Par-Cpu:InitParCPU+ExecParCPU";
    }
