#ifndef SMP_ENGINE_LA_2_F8_H
#define SMP_ENGINE_LA_2_F8_H
...
namespace bamboosmp {
  class SmpEngineLa2F8Bottom : public AbsSmpEngine {
  public:
    // Constructor
    SmpEngineLa2F8Bottom(const SmpObj &smp, size_t n);

    ~SmpEngineLa2F8Bottom() = default;

    auto GetEngineName() const -> String override {
      return "LA-Par-GPU-CAS:Figure8";
    }
    ...
    void PrintProfilingInfo() override {
      std::cout << "Executing SmpEngineLaCAS For Profiling ... " << std::endl;
    }
